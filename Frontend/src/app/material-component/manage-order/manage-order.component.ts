...
export class ManageOrderComponent implements OnInit {
  ...
  dispalyedColumns: string[] = ['name', 'category', 'price', 'quantity', 'total', 'edit'];
  dataSource: any = [];
  ...
  getCategorys() {
    this.categoryService.getFilteredCategorys().subscribe((response: any) => {
      ...
      this.snackbarServcie.openSnackBar(this.responseMessage, GlobalConstants.error);
    })
  }

  getProductByCategory(res: any) {
    this.productService.getProductByCategory(res.id).subscribe((response: any) => {
  ...
  getProdutDetails(res: any) {
    this.productService.getProductById(res.id).subscribe((response: any) => {
  ...
  add() {
    ...
    if (productName === undefined) {
      ...
      this.snackbarServcie.openSnackBar(GlobalConstants.productAdded, "success");
    }
    else {
      this.snackbarServcie.openSnackBar(GlobalConstants.productExistError, GlobalConstants.error);
    }
  }
  ...
  submitAction() {
    ...
    this.ngxService.start();
    this.billService.generateRapport(data).subscribe((response: any) => {
